...
public class LowestCostFilter extends AbstractCriteriaFilter {

    public LowestCostFilter(Criteria criteria) {
        super(criteria);
    }
    ...
    public List<GetPricedDietDto> filterSortDiets(List<GetPricedDietDto> diets) {
        ...
        for (List<GetPricedMealDto> dtos : categorizedDiets.values()) {
            dtos.sort(Comparator.comparing(GetPricedMealDto::getCost));
        }
